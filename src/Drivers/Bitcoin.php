...
use Ay4t\CryptoAddressValidator\Traits\Base58Check;

/**
 * Class Bitcoin
 * @package Ay4t\CryptoAddressValidator\Drivers
 * @since 1.0.0
 * @version 1.0.0
 * 
 * This class is used to validate the bitcoin address
 */
class Bitcoin extends AbstractDrivers
{
    use Base58Check;
     ...
     * 
     */
    public static function validate(string $address, $version = null) : bool
    {
        $type = self::typeOf($address);
